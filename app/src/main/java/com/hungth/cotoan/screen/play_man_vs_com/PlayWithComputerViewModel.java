...
public class PlayWithComputerViewModel extends BaseViewModel {
    ...
    public PlayWithComputerViewModel(IGameViewWithCom iGameView, ChessManRepository mChessManRepository) {
